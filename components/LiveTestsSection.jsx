...
export default function LiveTestsSection() {
  ...
  // Get tests for the active category
  const availableTests = testSeries[activeCategory] || [];

  // Carousel settings for tests
  ...
  return (
    <div className="py-8 px-4 mb-10">
      ...
      <div className="flex justify-center items-center gap-2 mb-6">
        ...
        <h2 className="text-xl font-bold">Live Mock Tests</h2>
      </div>
      ...
      <div className="relative">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow">
                <div className="relative">
                  ...
                  <div className="h-48 bg-gray-100 relative">
                    <Image
                      src={`/images/${activeCategory}-test.jpg`}
                      alt={test.title}
                      fill
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="border border-gray-300 text-gray-700 text-xs px-4 py-2 rounded-md">
                      View Details
                    </button>
                  </div>
                </div>
        ...
        {/* Navigation arrows */}
        <button className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white rounded-full shadow-md p-2 z-10">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
          </svg>
        </button>
        <button className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white rounded-full shadow-md p-2 z-10">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
