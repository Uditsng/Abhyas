...
export default function TestPage() {
  ...
  // Use params for both testId and courseId
  ...
  const handleSubmitTest = async () => {
    ...
    const result = {
      testId: testData.id, // Use .id for consistency
      courseId: testData.courseId, // Use .courseId for consistency
    ...
    <Flex direction={{ base: 'column', md: 'row' }} p={4} maxW="1200px" mx="auto" minH="100vh">
      ...
      >
        ...
        <VStack mt={6} spacing={3} align="stretch">
          ...
          <Button onClick={() => router.push(`/results/${testData.courseId}/${testData.Id}`)} variant="outline">
            Exit Test
          </Button>
        </VStack>
      </Box>
